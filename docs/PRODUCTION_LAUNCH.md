...
- [ ] Play Console app created (`com.hamoula.app`)
...
- [ ] App ID `com.miras.app` has Associated Domains (`applinks:hamula-cfc6c.web.app`)
- [ ] App Store Connect app created; bundle ID `com.miras.app`; iPhone only
